  ...
  return (
    <>
      <footer className="relative z-10 bg-white pb-10 pt-20 dark:bg-dark lg:pb-20 lg:pt-[120px] ">
        <div className="container mx-auto lg:w-11/12 px-5">
            ...
            <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="mb-7 text-base text-body-color dark:text-dark-6">
                  Join the Cooperative Revolution - Where Fair Financial
                ...
                <p className="flex items-center text-[15px] font-medium text-dark dark:text-white">
                  ...
                  <span>+234 (8088) 614 652</span>
                </p>
              </div>
            </div>

            <LinkGroup header="Product">
              <NavLink link="/loans-service" label="Loans" />
              <NavLink link="/contributions" label="Contributions" />
              <NavLink link="/#" label="User Flow" />
              <NavLink link="/#" label="User Strategy" />
            </LinkGroup>
            <LinkGroup header="Company">
              <NavLink link="/about" label="About Araromi" />
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
              <div className="mb-10 w-full">
                ...
                <p className="text-base text-body-color dark:text-dark-6">
                  &copy; {getFullYears} Araromi Cooperative Society
                </p>
              </div>
            </div>
          </div>
        ...
        <div>
          ...
          <span className="absolute right-10 top-10 z-[-1] animate-bounce">
            <svg
              width={75}
              height={75}
              viewBox="0 0 75 75"
