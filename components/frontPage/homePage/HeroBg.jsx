      ...
      <div>
        ...
        >
          <div className=" max-w-xl">
            <span className="inline-flex items-center gap-x-1.5 py-1.5 px-3 rounded-full text-xs font-medium bg-[#206bc4] text-white dark:bg-white dark:text-neutral-800">
