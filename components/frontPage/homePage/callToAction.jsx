...
const CallToAction = () => {
  return (
    <section className="mx-auto lg:w-10/12 pb-28">
        ...
        <div className="mb-5 px-5">
          <div className="mb-5 ">
            ...
            <p className="text-gray-700 text-[16px]">
              ...
              something bigger than yourself. Together, we can achieve what none
              of us could accomplish alone. Your cooperative awaits!
            </p>
          </div>
